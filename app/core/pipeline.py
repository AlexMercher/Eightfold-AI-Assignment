...
try:
    ...
    class PDFEncryptedError(Exception): pass
...
class ExtractionPipeline:
    ...
    def run(
        ...
        security_report = {}
        if not skip_security and file_bytes is not None and upload_security is not None:
            sec = self._stage(
                "security_scan",
        ...
        enh_report = None
        if resume_enhancer is not None:
