...
# GitHub identity URL classification constants.
GITHUB_RESERVED_ROUTES = {
    "login", "logout", "signup", "about", "contact", "pricing", "features",
    "explore", "trending", "marketplace", "sponsors", "settings",
    "notifications", "issues", "pulls", "actions", "dashboard",
    "organizations", "orgs", "topics", "collections", "events", "security",
    "enterprise", "education", "new", "import", "codespaces", "copilot",
    "mobile", "readme",
}

GITHUB_PLACEHOLDER_USERNAMES = {
    "username", "yourusername", "yourname", "user", "example",
    "placeholder", "githubusername", "myusername",
}
